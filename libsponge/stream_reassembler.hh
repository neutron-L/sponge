...
class StreamReassembler {
  private:
    ...
    size_t _unassembled_size{};  // The number of unressembled and unread bytes
    unsigned long _first_unread_idx{};
    unsigned long _first_unassembled_idx{};
    bool _eof{};  // whether receive the last byte
